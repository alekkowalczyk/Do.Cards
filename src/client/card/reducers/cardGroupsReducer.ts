                ...
                if (cardToMove) {
                    ...
                    return state.map(c => {
                        if (c.id === cardToMove.id) {
                            return movedCard;
                        } else if (c.IsSameParent(cardToMove.parentId) && !cardToMove.IsSameParent(movedCard.parentId)) {
                        ...
                        } else if (c.IsSameParent(movedCard.parentId) && cardToMove.IsSameParent(movedCard.parentId)) {
